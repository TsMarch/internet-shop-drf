...
from .serializers import ProductSerializer, ProductListSerializer, ProductSerializerMixin, CartSerializer, \
    CartItemSerializer
...
class CartViewSet(ModelViewSet):
    ...
    serializer_action_classes = {"list": CartSerializer, "retrieve": CartSerializer}
